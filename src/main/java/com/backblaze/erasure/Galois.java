 ...
 * 乘法运算在擦除编码的内环中，因此对其进行了优化。
 * 将类设为“final”会有一点帮助，并且让EXP_表重复数据，
 * 因此不需要将两个对数的和绑定到255。
 */
public final class Galois {
     ...
     * 有许多多项式可以生成256个元素的Galois域。选择是任意的，我们只使用第一个。
     * The possibilities are: 29, 43, 45, 77, 95, 99, 101, 105,
     * 113, 135, 141, 169, 195, 207, 231, and 245.
     * 可能性有：29、43、45、77、95、99、101、105、113、135、141、169、195、207、231和245。
     */
     ...
     * 对数表的倒数。将整数对数映射到字段的成员。没有255的条目，因为最高的日志是254。
     *
